(() => {
    ...
    let formValidate = {
        ...
        addError(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.error && !formRequiredItem.value) formRequiredItem.parentElement.insertAdjacentHTML("beforeend", `<div class="form__error">${formRequiredItem.dataset.error}</div>`);
            if (formRequiredItem.dataset.error && formRequiredItem.value) formRequiredItem.parentElement.insertAdjacentHTML("beforeend", `<div class="form__error">Please provide valid email</div>`);
        },
